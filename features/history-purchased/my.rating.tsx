'use client'
import { Avatar, Box, Button, Divider, Fade, IconButton, InputAdornment, Modal, Popover, Rating, Snackbar, SnackbarContent, TextField, Typography } from '@mui/material';
            ...
            >
                <Fade in={open}>
                    ...
                    >
                        ...
                        <div className='mt-10'>
                            {myRating !== null ?
                                <div className="flex gap-5 mb-7 ml-7 justify-between items-start">
